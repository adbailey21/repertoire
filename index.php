...
<form method="POST" action="">
    ...
    <td>Box URL</td><td><input type="text" name="boxUrl" /></td>
    </tr><tr>
    ...
    <?php } ?>
        ...
        <?php
            for($i=0;$i<sizeof($song);$i++){
                ...
                echo "<td class='list'><a href='" . $song[$i]['boxUrl'] . "' target='_BLANK'>" . $song[$i]['title'] . "</a></td>";
                echo "<td class='list'>";
                    $auth = "";
                ...
                echo "<td class='list'>" . $song[$i]['songId'] . "</td>";
                echo "<td class='list'><a href='editSong.php?sid=" . $song[$i]['songId'] . "'>1EDIT SONG</a></td>";
